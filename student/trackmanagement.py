...
class Track:
    ...
    def __init__(self, meas, id):
        ...
        pos_sens = np.ones((4, 1)) # initiliaze homogeneous coordinates
        pos_sens[0:3] = meas.z[0:3] # measurements in sensor coordinates
        pos_veh = meas.sensor.sens_to_veh*pos_sens # convert measurements from sensor to vehicle coordinates
